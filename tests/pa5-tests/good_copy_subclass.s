...
.asm_label_1:
			...
			movl	%r10d, %r9d
			xorl	$1, %r9d
			## branch .dispatch_1_void
			test	%r10d, %r10d
			jnz		.dispatch_1_void
			## branch .dispatch_1_not_void
			test	%r9d, %r9d
			jnz		.dispatch_1_not_void
.dispatch_1_void:
			movq	$string_1, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.dispatch_1_not_void
.dispatch_1_not_void:
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			...
			movq	16(%r8), %rax
			## find method set_val in vtable[5]
			movq	40(%rax), %rax
...
.dispatch_8_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method get_val in vtable[6]
			movq	48(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.globl string_7
string_7:
			.string "ERROR: 17: Exception: static dispatch on void"
