...
.dispatch_1_not_void:
			...
			movq	16(%r10), %rax
			## find method get_attr_1 in vtable[9]
			movq	72(%rax), %rax
...
.dispatch_2_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method get_attr_2 in vtable[10]
			movq	80(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_7_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method get_attr_3 in vtable[11]
			movq	88(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
