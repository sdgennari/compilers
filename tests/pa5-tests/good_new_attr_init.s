...
Main..new:		## Constructor for Main
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Main (size: 5)
			movq	$8, %rsi
			movq	$5, %rdi
			call	calloc
			movq	%rax, %rbx
...
.dispatch_2_not_void:
			...
			movq	16(%r9), %rax
			## find method get_aaa in vtable[5]
			movq	40(%rax), %rax
...
.dispatch_3_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method get_val in vtable[5]
			movq	40(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_5_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method get_default in vtable[6]
			movq	48(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.globl type_name_AA 
type_name_AA:			## type_name string for AA
			.string "AA"

.globl type_name_AAA 
type_name_AAA:			## type_name string for AAA
			.string "AAA"
