...
.dispatch_8_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r11), %rax
			## find method some_method in vtable[9]
			movq	72(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 1 params from stack with subq
...
.dispatch_9_not_void:
			...
			movq	$A..vtable, %rax
			## find method some_methodin vtable[9]
			movq	72(%rax), %rax
			## call method
			call	*%rax
			## removing 1 params from stack with subq
...
.dispatch_10_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r12), %rax
			## find method another_method in vtable[10]
			movq	80(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_12_not_void:
			...
			## get ptr to vtable from static type
			movq	$A..vtable, %rax
			## find method another_methodin vtable[10]
			movq	80(%rax), %rax
			## call method
			call	*%rax
			## removing 0 params from stack with subq
...
.globl string_8
string_8:
			.string "ERROR: 9: Exception: static dispatch on void"
...
.globl string_10
string_10:
			.string "ERROR: 12: Exception: static dispatch on void"
