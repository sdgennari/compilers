...
.Main_main_1:
			...
			movq	%rax, %r13
			movl	$7, 24(%r13)
			## use lt_helper to compare %r12 < %r13
			...
			movq	%rax, %r13
			movl	$777, 24(%r13)
			## use lt_helper to compare %r11 < %r13
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			...
			popq	%rcx
			movq	%rax, %r12
			movq	$string_2, 24(%r12)
			## use lt_helper to compare %r13 < %r12
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			...
			movq	%rax, %r11
			movl	$0, 24(%r11)
			## use lt_helper to compare %r13 < %r11
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			...
			## assign
			movq	%r10, %r12
			## use lt_helper to compare %r11 < %r12
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			...
			## assign
			movq	%r8, %r11
			## use lt_helper to compare %r12 < %r11
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
