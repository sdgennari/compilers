...
.dispatch_76_not_void:
			...
			movq	%rax, %r13
			movl	$0, 24(%r13)
			## use eq_helper to compare %r8 = %r13
			## push caller-saved regs and self ptr
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
