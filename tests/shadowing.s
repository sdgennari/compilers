...
Main..new:		## Constructor for Main
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Main (size: 6)
			movq	$8, %rsi
			movq	$6, %rdi
			call	calloc
			movq	%rax, %rbx
...
.Main_main_1:
			...
			movq	16(%rbx), %rax
			## find method some_method in vtable[10]
			movq	80(%rax), %rax
...
.globl string_5
string_5:
			.string "ERROR: 56: Exception: case on void"
...
.globl string_6
string_6:
			.string "ERROR: 56: Exception: case without matching branch: Int"
