...
Complex..vtable:		## vtable for Complex
			.quad type_name_Complex
			.quad Complex..new
			.quad Object.abort
			.quad Object.copy
			.quad Object.type_name
...
Complex..new:		## Constructor for Complex
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Complex (size: 5)
			movq	$8, %rsi
			movq	$5, %rdi
			call	calloc
			movq	%rax, %rbx
...
.dispatch_12_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r11), %rax
			## find method x_value in vtable[15]
			movq	120(%rax), %rax
			## call method dynamically
			call	*%rax
...
.dispatch_14_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r8), %rax
			## find method y_value in vtable[16]
			movq	128(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_20_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r9), %rax
			## find method reflect_X in vtable[12]
			movq	96(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_21_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r12), %rax
			## find method reflect_0 in vtable[11]
			movq	88(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_25_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r10), %rax
			## find method reflect_Y in vtable[13]
			movq	104(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 0 params from stack with subq
...
.dispatch_26_not_void:
			...
			## get ptr to vtable from receiver obj
			movq	16(%r11), %rax
			## find method equal in vtable[14]
			movq	112(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 1 params from stack with subq
...
.globl type_name_Complex 
type_name_Complex:			## type_name string for Complex
			.string "Complex"
...
.globl string_6
string_6:
			.string "ERROR: 3: Exception: dispatch on void"
...
.globl string_5
string_5:
			.string "ERROR: 64: Exception: dispatch on void"
...
.globl string_4
string_4:
			.string "ERROR: 62: Exception: dispatch on void"
