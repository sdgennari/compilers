...
Bar..new:		## Constructor for Bar
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Bar (size: 12)
			movq	$8, %rsi
			movq	$12, %rdi
			call	calloc
			movq	%rax, %rbx
...
.case_1_exit:
			...
			movq	16(%rbx), %rax
			## find method printh in vtable[9]
			movq	72(%rax), %rax
...
Bazz..new:		## Constructor for Bazz
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Bazz (size: 6)
			movq	$8, %rsi
			movq	$6, %rdi
			call	calloc
			movq	%rax, %rbx
...
.asm_label_9:
			...
			test	%r9d, %r9d
			jnz		.case_13_void
			## branch .case_13_not_void
			test	%r8d, %r8d
			jnz		.case_13_not_void
.case_13_void:
			movq	$string_1, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_13_not_void
.case_13_not_void:
			## move type tag of %r10 into %r8
			movq	0(%r10), %r8
			## check for type Razz
...
.asm_label_10:
			...
			test	%r8d, %r8d
			jnz		.case_15_void
			## branch .case_15_not_void
			test	%r9d, %r9d
			jnz		.case_15_not_void
.case_15_void:
			movq	$string_1, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_15_not_void
.case_15_not_void:
			## move type tag of %r10 into %r8
			movq	0(%r10), %r8
			## check for type Razz
...
.asm_label_11:
			...
			test	%r8d, %r8d
			jnz		.case_17_void
			## branch .case_17_not_void
			test	%r9d, %r9d
			jnz		.case_17_not_void
.case_17_void:
			movq	$string_3, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_17_not_void
.case_17_not_void:
			## move type tag of %r10 into %r8
			movq	0(%r10), %r8
			## check for type Razz
...
.dispatch_18_void:
			...
			movq	$0, %rax
			call	exit
			jmp		.dispatch_18_not_void
.dispatch_18_not_void:
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			pushq	%rdi
...
Razz..new:		## Constructor for Razz
			...
			pushq	%r14
			pushq	%r15
			## allocate space for Razz (size: 10)
			movq	$8, %rsi
			movq	$10, %rdi
			call	calloc
			movq	%rax, %rbx
...
.asm_label_14:
			...
			test	%r9d, %r9d
			jnz		.case_21_void
			## branch .case_21_not_void
			test	%r8d, %r8d
			jnz		.case_21_not_void
.case_21_void:
			movq	$string_1, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_21_not_void
.case_21_not_void:
			## move type tag of %r10 into %r8
			movq	0(%r10), %r8
			## check for type Razz
...
.asm_label_15:
			...
			test	%r9d, %r9d
			jnz		.case_23_void
			## branch .case_23_not_void
			test	%r8d, %r8d
			jnz		.case_23_not_void
.case_23_void:
			movq	$string_3, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_23_not_void
.case_23_not_void:
			## move type tag of %r10 into %r8
			movq	0(%r10), %r8
			## check for type Razz
...
.asm_label_18:
			...
			test	%r10d, %r10d
			jnz		.case_27_void
			## branch .case_27_not_void
			test	%r9d, %r9d
			jnz		.case_27_not_void
.case_27_void:
			movq	$string_6, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.case_27_not_void
.case_27_not_void:
...
.asm_label_21:
			...
			movl	%r8d, %r9d
			xorl	$1, %r9d
			## branch .dispatch_30_void
			test	%r8d, %r8d
			jnz		.dispatch_30_void
			## branch .dispatch_30_not_void
			test	%r9d, %r9d
			jnz		.dispatch_30_not_void
.dispatch_30_void:
			movq	$string_9, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.dispatch_30_not_void
.dispatch_30_not_void:
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			pushq	%rdi
...
.globl type_name_Bar 
type_name_Bar:			## type_name string for Bar
			.string "Bar"

.globl type_name_Bazz 
type_name_Bazz:			## type_name string for Bazz
			.string "Bazz"
...
.globl type_name_Foo 
type_name_Foo:			## type_name string for Foo
			.string "Foo"
...
.globl type_name_Razz 
type_name_Razz:			## type_name string for Razz
			.string "Razz"
...
.globl string_4
string_4:
			.string "ERROR: 4: Exception: case without matching branch: SELF_TYPE"

.globl string_9
string_9:
			.string "ERROR: 31: Exception: dispatch on void"

.globl string_1
string_1:
			.string "ERROR: 39: Exception: case on void"

.globl string_2
string_2:
			.string "ERROR: 39: Exception: case without matching branch: SELF_TYPE"

.globl string_7
string_7:
			.string "ERROR: 26: Exception: case without matching branch: SELF_TYPE"

.globl string_8
string_8:
			.string "ERROR: 31: Exception: static dispatch on void"
...
.globl string_3
string_3:
			.string "ERROR: 4: Exception: case on void"
...
.globl string_6
string_6:
			.string "ERROR: 26: Exception: case on void"
