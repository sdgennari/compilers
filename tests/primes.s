...
Main..new:		## Constructor for Main
			...
			addq	$0, %rsp
			movq	%r8, 24(%rbx)
			## self[4] testee <- init exp
			## allocate space to store 0 spilled regs
			subq	$0, %rsp
			## load self[3] (out) into %r9
			movq	24(%rbx), %r9
			## assign
			movq	%r9, %r8
			## remove temporary stack space for 0 spilled regs
