...
Main.main:
			pushq	%rbp
			movq	%rsp, %rbp
			## allocate space to store 9 spilled regs
			subq	$72, %rsp
			## push callee-saved regs
			pushq	%r12
			pushq	%r13
...
.asm_label_6:
			...
			popq	%r13
			popq	%r12
			## remove temporary stack space for 9 spilled regs
			addq	$72, %rsp
			leave
			ret
...
.globl string_3
string_3:
			.string "ERROR: 51: Exception: division by zero"

.globl string_2
string_2:
			.string "ERROR: 50: Exception: division by zero"

.globl string_4
string_4:
			.string "ERROR: 52: Exception: division by zero"

.globl string_5
string_5:
			.string "ERROR: 53: Exception: division by zero"

.globl string_1
string_1:
			.string "ERROR: 47: Exception: division by zero"

.globl string_6
string_6:
			.string "ERROR: 54: Exception: division by zero"
