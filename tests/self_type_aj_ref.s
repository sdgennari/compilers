...
B..new:                 ## constructor for B
			...
			movq %rax, %r12
                        ...
                        ## self[3] holds field a (SELF_TYPE)
                        movq $0, %r13
                        movq %r13, 24(%r12)
...
l3:                     pushq %r13
                        ...
                        movq $A..vtable, %r14
                        ## look up a() at offset 9 in vtable
                        movq 72(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
l4:                     pushq %r13
                        ...
                        movq 16(%r13), %r14
                        ## look up me() at offset 13 in vtable
                        movq 104(%r14), %r14
                        call *%r14
                        addq $8, %rsp
                        popq %rbp
...
.globl string11
string11:               # "ERROR: 46: Exception: dispatch on void\\n"
.byte  69 # 'E'
.byte  82 # 'R'
.byte  82 # 'R'
.byte  79 # 'O'
