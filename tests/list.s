...
.dispatch_14_not_void:
			...
			## get ptr to vtable from self
			movq	16(%rbx), %rax
			## find method print_list in vtable[9]
			movq	72(%rax), %rax
			## call method dynamically
			call	*%rax
			## removing 1 params from stack with subq
...
.globl string_1
string_1:
			.string "ERROR: 50: Exception: dispatch on void"

.globl string_8
string_8:
			.string "ERROR: 129: Exception: dispatch on void"
...
.globl string_2
string_2:
			.string "ERROR: 108: Exception: dispatch on void"

.globl string_9
string_9:
			.string "ERROR: 132: Exception: dispatch on void"
