...
.globl AWrapper..vtable
AWrapper..vtable:		## vtable for AWrapper
			.quad type_name_AWrapper
			.quad AWrapper..new
			.quad Object.abort
			.quad Object.copy
			.quad Object.type_name
...
.globl AWrapper..new
AWrapper..new:		## Constructor for AWrapper
			pushq	%rbp
			movq	%rsp, %rbp
			## allocate space to store 0 spilled regs
			subq	$0, %rsp
			...
			pushq	%r14
			pushq	%r15
			## allocate space for AWrapper (size: 4)
			movq	$8, %rsi
			movq	$4, %rdi
			call	calloc
			movq	%rax, %rbx
...
.asm_label_15:
			...
			movl	%r8d, %r10d
			xorl	$1, %r10d
			## branch .dispatch_20_void
			test	%r8d, %r8d
			jnz		.dispatch_20_void
			## branch .dispatch_20_not_void
			test	%r10d, %r10d
			jnz		.dispatch_20_not_void
.dispatch_20_void:
			movq	$string_17, %rdi
			call	raw_out_string
			movq	$0, %rax
			call	exit
			jmp		.dispatch_20_not_void
.dispatch_20_not_void:
			pushq	%rcx
			pushq	%rdx
			pushq	%rsi
			pushq	%rdi
...
.globl type_name_AWrapper 
type_name_AWrapper:			## type_name string for AWrapper
			.string "AWrapper"
...
.globl string_6
string_6:
			.string "ERROR: 13: Exception: dispatch on void"
...
.globl string_4
string_4:
			.string "ERROR: 11: Exception: dispatch on void"
...
.globl string_2
string_2:
			.string "ERROR: 63: Exception: dispatch on void"
